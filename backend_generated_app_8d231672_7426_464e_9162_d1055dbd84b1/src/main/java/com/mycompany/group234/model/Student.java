...
public class Student extends AbstractStudent {
  ...
  @AttributeOverrides({
            	@AttributeOverride(name = "personId", column = @Column(name = "\"AdhaarNo_PersonId\"")) ,
            	@AttributeOverride(name = "aadharNo", column = @Column(name = "\"AdhaarNo_AadharNo\""))  }) 
  private Person adhaarNo;
